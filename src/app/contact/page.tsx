...
// Set to true to show the contact form
    ...
    <>
      ...
      <section className="relative w-full bg-cream overflow-hidden pt-[48px] md:pt-[64px] lg:pt-[88px] pb-[80px] md:pb-[100px] lg:pb-[150px]">
        ...
        <div className="relative z-10 mx-auto flex w-[92%] flex-col items-end gap-12 md:gap-16 lg:gap-20">
          ...
          <div className="flex w-full md:w-[80%] lg:w-[60%] flex-col items-start gap-4 md:gap-6">
            ...
            <div className="flex flex-col gap-2">
              <a
                ...
                className="text-[18px] md:text-[20px] lg:text-[22px] font-medium leading-[1.5] tracking-[-0.4px] md:tracking-[-0.6px] text-dark underline underline-offset-4 decoration-dark/40 transition-opacity hover:opacity-60"
              >
          ...
          {/* Form — toggle SHOW_FORM to true to restore */}
          {SHOW_FORM && (
            <form
                      ...
                      >
                        {selectedTypes.includes(type) && (
                          <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                            <path d="M2 6L5 9L10 3" stroke="#f1efed" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                          </svg>
                        )}
                      </div>
