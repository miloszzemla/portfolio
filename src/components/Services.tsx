  ...
  return (
    <section className="relative w-full bg-cream overflow-hidden py-[100px]">
      ...
      <div className="relative z-10 mx-auto flex w-[92%] flex-col items-start gap-16">
        ...
        {/* Content: 30% description / 60% grid */}
        <div className="flex w-full items-start justify-between">
          ...
          >
            <p className="text-[24px] font-medium leading-[1.5] tracking-[-0.8px] text-dark">
              ...
              field. Throughout my career, I&apos;ve acquired various skills,
              which I continue to perfect.
            </p>
          </motion.div>
          ...
          <div className="flex w-[60%] flex-col gap-16">
            ...
            <div className="flex w-full items-start justify-between">
              {services.slice(0, 2).map((service, i) => (
                ...
                >
                  <div className="mb-6">{icons[service.title]}</div>
                  <h3 className="text-[26px] font-medium leading-[1.5] tracking-[-1px] text-dark">
                    {service.title}
                  </h3>
