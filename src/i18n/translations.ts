export const translations = {
  en: {
    ...
    contact: {
      ...
      projectType: "What\u2019s Your Project About?",
      projectTypes: [
  ...
  pl: {
    ...
    contact: {
      title: "Kontakt",
      intro:
        "Ch\u0119tnie si\u0119 odezw\u0119! Je\u015bli nie lubisz formularzy, napisz do mnie bezpo\u015brednio \u2014 porozmawiajmy o Twoim kolejnym projekcie!",
      name: "Imi\u0119",
      namePlaceholder: "Twoje imi\u0119",
      email: "Email",
      emailPlaceholder: "twoj@email.com",
      projectType: "Czego dotyczy Tw\u00f3j projekt?",
      projectTypes: [
        "Projekt strony wielostronicowej",
        "Projekt landing page",
        "Budowa strony w Framer",
        "Budowa landing page w Framer",
      ],
      budget: "Tw\u00f3j bud\u017cet",
      budgetPlaceholder: "np. 5 000 - 10 000 z\u0142",
      details: "Szczeg\u00f3\u0142y projektu",
      detailsPlaceholder: "Opowiedz o swoim projekcie...",
      submit: "Wy\u015blij",
      sending: "Wysy\u0142am...",
      sent: "Wys\u0142ano!",
